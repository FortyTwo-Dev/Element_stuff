...
public enum ModArmorMaterial implements IArmorMaterial {
    ...
    GEM("gem", -1, new int[] {99999999,99999999,99999999,99999999}, 12,SoundEvents.ARMOR_EQUIP_DIAMOND, 99999.0F,99999.0F , () -> {
        return Ingredient.of(ModItems.FLYINGGEM.get());
    });
    ...
    public String getName() {
        return ElementStuff.MODID + ":" + this.name;
    }
